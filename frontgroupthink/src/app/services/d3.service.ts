...
//
//     //this is for keeping the scale on
//
//     //maybe we call reset on every scroll but also on every viewreset
//
...
//   } // end reset
// }
// // applyScrollableBehavior(map, scrollTop) {
// //
// //   function makeTestPosition(scrollTop, number) {
// //     if(number === 0) {
// //       return 0
...
// }
//
// //STUFF THAT ONLY NEEDS TO HAPPEN ONCE FOR THE json
// //
//
//
// //     d3.json('http://localhost:8080/geoJSON/points.geojson', function(error, incidents) {
