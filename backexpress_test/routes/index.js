...
// router.delete('/deleteVignette', function(req, res, next) {
...
// router.put('/updateVignette', function(req, res, next) {
//   var vignette = new Vignette(req.body);
//   console.log(res);
//   Vignette.update({_id : req.body.id}), vignette, function(err) {
//     if (err) {
